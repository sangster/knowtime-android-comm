        ...
        extends FareId
{
    ...
    public FareRule( final KnowTimeAccess knowTime, final String id, final Optional<String> routeId,
                     final Optional<String> originId, final Optional<String> destinationId,
