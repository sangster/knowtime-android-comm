        ...
        extends KnowtimeModel
{
    ...
    public FeedInfo( final KnowTimeAccess knowTime, final String publisherName,
                     final String publisherUrl, final String language,
                     final Optional<String> startDate, final Optional<String> endDate,
